...
from NHDPlus_SWAT.find_station_region import find_station_region
...
def get_huc12_geometries(list_of_huc12s):
    ...
    print(VPUID)
    # Read the shapefile
    path = f"/data2/MyDataBase/SWATGenXAppData/NHDPlusData/SWATPlus_NHDPlus/{VPUID}/unzipped_NHDPlusVPU/"
...
def find_station(search_term='metal'):
    governmental_boundries_path =  "/data2/MyDataBase/SWATGenXAppData/USGS/GovernmentUnits_National_GDB/GovernmentUnits_National_GDB.gdb"
    USGS_stations_path = "/data2/MyDataBase/SWATGenXAppData/USGS/streamflow_stations/CONUS/streamflow_stations_CONUS.csv"
    USGS_CONUS_shp = "/data2/MyDataBase/SWATGenXAppData/USGS/streamflow_stations/CONUS/streamflow_stations_CONUS.shp"
