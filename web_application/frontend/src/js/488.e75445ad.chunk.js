      ...
      var r,
                  ...
                  e.forEach(function (e) {
                    'first-contentful-paint' === e.name &&
                      ...
                      e.startTime < r.firstHiddenTime &&
                        ((i.value = Math.max(e.startTime - d(), 0)), i.entries.push(e), t(!0)));
                  });
                });
              o &&
        ...
        R = function () {
          'interactionCount' in performance ||
            r ||
            (r = p('event', D, { type: 'event', buffered: !0, durationThreshold: 0 }));
        },
        x = [],
        H = new Map(),
        N = 0,
        ...
        j = function (e) {
          var n = self.requestIdleCallback || self.setTimeout,
            t = -1;
          return (e = g(e)), 'hidden' === document.visibilityState ? e() : ((t = n(e)), h(e)), t;
        },
        _ = [200, 500],
        z = function (e, n) {
              ...
              var r,
                ...
                o = function (e) {
                  j(function () {
                    e.forEach(O);
                    var n = (function () {
                      var e = Math.min(x.length - 1, Math.floor((B() - N) / 50));
                      return x[e];
                    })();
                    n &&
                      n.latency !== i.value &&
          ...
          (n = n || {}),
            S(function () {
              var t,
                ...
                o = function (e) {
                  n.reportAllChanges || (e = e.slice(-1)),
                    e.forEach(function (e) {
                      e.startTime < r.firstHiddenTime &&
                        ((i.value = Math.max(e.startTime - d(), 0)), (i.entries = [e]), t());
                    });
                },
              ...
              if (a) {
                ...
                var c = g(function () {
                  J[i.id] || (o(a.takeRecords()), a.disconnect(), (J[i.id] = !0), t(!0));
                });
                ['keydown', 'click'].forEach(function (e) {
                  ...
                  s(function (r) {
                    (i = l('LCP')),
                      (t = v(e, i, G, n.reportAllChanges)),
                      m(function () {
                        (i.value = performance.now() - r.timeStamp), (J[i.id] = !0), t(!0);
                      });
                  });
              }
            });
        ...
        X = new Date(),
        Y = function (e, n) {
          i || ((i = n), (o = e), (a = new Date()), ee(removeEventListener), Z());
        },
        Z = function () {
          if (o >= 0 && o < a - X) {
            var e = {
          ...
          (n = n || {}),
            S(function () {
              var t,
                ...
                u = function (e) {
                  e.startTime < r.firstHiddenTime &&
                    ((a.value = e.processingStart - e.startTime), a.entries.push(e), t(!0));
                },
                f = function (e) {
                  e.forEach(u);
                },
