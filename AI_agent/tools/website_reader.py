...
def website_reader(url="https://docs.agno.com/introduction", max_links=5, recreate_db=False, logger=None):
    """
    ...
    log.info(f"Analyzing website: {url}")
    ...
    log.info(f"Website knowledge base initialized for {url}")
