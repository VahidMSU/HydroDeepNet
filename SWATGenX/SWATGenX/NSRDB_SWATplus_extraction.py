...
class NSRDB_contructor:
    ...
    def write_file_for_index(self, nsrdb_idx, data_all, date_Range):
        """Helper function to write a single file for a specific index"""
        try:
    ...
    def write_to_file(self, data_all):
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            executor.map(partial(self.write_file_for_index, data_all=data_all, date_Range=date_Range), self.nsrdb_indexes)
