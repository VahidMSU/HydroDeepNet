...
class SWATGenXPaths:
    ...
    NLCD_path: str = f"{base_path}NLCD/"
    gSSURGO_path: str = f"{base_path}gSSURGO/"
    PRISM_path: str = f"{base_path}PRISM/"
    DEM_path: str = f"{base_path}DEM/"
    NHDPlus_path: str = f"{base_path}NHDPlusHR/"
    Downloaded_CONUS_DEM_path: str = f"{base_path}DEM/CONUS/LF2023_FBFM13_240_CONUS/Tif/"
    ...
    extracted_nhd_swatplus_path: str = f"{base_path}NHDPlusHR/VPUID/"
    report_path: str = f"{codes_path}/logs/"

    # Specific Data Files
    critical_error_file_path: str = f"{codes_path}critical_errors.txt"
    NLCD_release_path: str = f"{base_path}NLCD/CONUS/"
    gSSURGO_raster: str = f"{base_path}gSSURGO/CONUS/MapunitRaster_30m.tif"
    swatplus_gssurgo_csv: str = f"{base_path}gSSURGO/ssurgo.csv"
    DEM_13_arc_second_list: str = f"{base_path}DEM/DEM_13_arc_second.USGS"
    NHDPlus_VPU_National_path: str = f"{base_path}NHDPlusHR/CONUS/"
    ...
    gSSURGO_CONUS_gdb_path: str = f"{base_path}gSSURGO/CONUS/gSSURGO_CONUS.gdb"
    ...
    # Additional Paths
    LanduseTable: str = f"{base_path}NLCD/landuse_lookup.csv"
