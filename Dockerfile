...
# Now install GDAL from apt repository (moved to the end)
RUN apt-get update && \
...
# Install QGIS after GDAL is properly installed (moved to the end)
RUN apt-get update && \
...
# SWAT+ Installation - with improved error handling (moved to the end)
