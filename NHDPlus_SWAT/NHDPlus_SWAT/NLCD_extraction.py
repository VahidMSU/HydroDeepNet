...
class NLCDExtractor:
    def __init__(self, VPUID, epoch):
        ...
        self.NLCD_all_files_path = (
            "/data/MyDataBase/SWATGenXAppData/LandUse/NLCD_landcover_2021_release_all_files_20230630/"
        )
        self.HUC4_base_path = fr"/data/MyDataBase/SWATGenXAppData/NHDPlusData/SWATPlus_NHDPlus/{VPUID}/unzipped_NHDPlusVPU/"
        self.temp_path = fr"/data/MyDataBase/SWATGenXAppData/LandUse/NLCD_CONUS/{VPUID}/rect.shp"
        self.original_out_raster = fr"/data/MyDataBase/SWATGenXAppData/LandUse/NLCD_CONUS/{VPUID}/NLCD_{VPUID}_{epoch}.tif"
        self.VPUID_DEM_base = f"/data/MyDataBase/SWATGenXAppData/DEM/VPUID/{VPUID}"
        self.NLCD_path = None
    ...
    def NLCD_extract_by_VPUID(self):
        ...
        output_path = fr"/data/MyDataBase/SWATGenXAppData/LandUse/NLCD_CONUS/{self.VPUID}/NLCD_{self.VPUID}_{self.epoch}_30m.tif"
        ...
        for resolution in resolutions:
            output_path = fr"/data/MyDataBase/SWATGenXAppData/LandUse/NLCD_CONUS/{self.VPUID}/NLCD_{self.VPUID}_{self.epoch}_{resolution}m.tif"
...
def NLCD_extract_by_VPUID(VPUID, epoch):
    original_out_raster = fr"/data/MyDataBase/SWATGenXAppData/LandUse/NLCD_CONUS/{VPUID}/NLCD_{VPUID}_{epoch}.tif"
