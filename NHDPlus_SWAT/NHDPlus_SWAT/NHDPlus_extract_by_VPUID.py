...
from NHDPlus_SWAT.NHD_SWAT_fun import *
import zipfile
import glob
import os 
import utm 
...
def NHDPlus_extract_by_VPUID(VPUID):
    ...
    nhdplus_unzipped_files = f'/data/MyDataBase/SWATGenXAppData/NHDPlusData/SWATPlus_NHDPlus/{VPUID}/streams.pkl'
    
    if not os.path.exists(nhdplus_unzipped_files):
        extracted_nhd_path = f'/data/MyDataBase/SWATGenXAppData/NHDPlusData/SWATPlus_NHDPlus/{VPUID}/'
        ...
        nhdplus_zipped_path = "/data/MyDataBase/SWATGenXAppData/NHDPlusData/NHDPlus_VPU_National"
...
if __name__ == "__main__":
    BASE_PATH = r"/data/MyDataBase/SWATGenXAppData/NHDPlusData"
