...
def fetch_station_information(VPUIDs, Region):
    ...
    all_meta_data.to_csv(f"/data/MyDataBase/SWATGenXAppData/Documentations/Region{Region}/all_meta_data.csv", index=False)
    all_streamflow_stations.to_file(f"/data/MyDataBase/SWATGenXAppData/Documentations/Region{Region}/all_streamflow_stations.shp")
    
    return all_streamflow_stations, all_meta_data, all_list_of_huc12s

VPUIDs = get_all_VPUIDs()
Region = "02"
streamflow_base_path = "/data/MyDataBase/SWATGenXAppData/USGS/streamflow_stations/VPUID"
national_nhdplus_path = "/data/MyDataBase/SWATGenXAppData/NHDPlusData/NHDPlus_H_National_Release_1_GDB/NHDPlus_H_National_Release_1_GDB.gdb"
national_doc_region_path = "/data/MyDataBase/SWATGenXAppData/Documentations/Region02/"
...
plt.savefig("/data/MyDataBase/SWATGenXAppData/Documentations/Region02/streamflow_stations.jpeg", dpi=300)
plt.show()
