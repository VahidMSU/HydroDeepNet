from NHDPlus_SWAT.USGS_monitoring_extraction import get_streamflow_stations_for_state, organizing_stations_into_CONUS, organizing_CONUS_by_VPUID
import os
...
if __name__ == "__main__":
    ...
    os.makedirs("/data/MyDataBase/SWATGenXAppData/USGS/streamflow_stations/", exist_ok=True)
    os.makedirs("/data/MyDataBase/SWATGenXAppData/USGS/streamflow_stations/state/", exist_ok=True)
    os.makedirs("/data/MyDataBase/SWATGenXAppData/USGS/streamflow_stations/CONUS/", exist_ok=True)
    os.makedirs("/data/MyDataBase/SWATGenXAppData/USGS/streamflow_stations/VPUID/", exist_ok=True)
