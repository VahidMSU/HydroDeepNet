...
TARGET_PATH = "/data/MyDataBase/SWATGenXAppData/SWATplus_by_VPUID/"
...
for VPUID in VPUIDs:
    ...
    for NAME in NAMES:
        ...
        if not os.path.exists(os.path.join("/data/MyDataBase/SWATGenXAppData/SWAT_input/huc12", NAME, SWAT_MODEL_NAME)):
            shutil.copytree(os.path.join(TARGET_PATH, VPUID, "huc12", NAME, SWAT_MODEL_NAME), os.path.join("/data/MyDataBase/SWATGenXAppData/SWAT_input/huc12", NAME, SWAT_MODEL_NAME))
