...
import os
import logging
from NHDPlus_SWAT.read_VPUID import find_VPUID
...
if __name__ == "__main__":
    governmental_boundries_path =  "/data/MyDataBase/SWATGenXAppData/USGS/GovernmentUnits_National_GDB/GovernmentUnits_National_GDB.gdb"
    USGS_stations_path = "/data/MyDataBase/SWATGenXAppData/USGS/streamflow_stations/CONUS/streamflow_stations_CONUS.csv"
    USGS_CONUS_shp = "/data/MyDataBase/SWATGenXAppData/USGS/streamflow_stations/CONUS/streamflow_stations_CONUS.shp"
    search_term = "metal"
