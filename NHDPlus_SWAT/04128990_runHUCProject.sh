...
%OSGEO4W_ROOT%\bin\python3.exe -c "from QSWATPlus3_9 import runHUCProject; runHUCProject(VPUID = '0407', LEVEL = 'huc12', NAME = '04128990', MODEL_NAME = 'SWAT_MODEL_gssurgo')"
