...
class PSOOptimizer:
    ...
    def ask(self):
        ...
        with Manager() as manager:
            ...
            for It in range(self.max_it):
                ...
                os.makedirs(fr"/data/MyDataBase/SWATGenXAppData/SWATplus_by_VPUID/{self.VPUID}/{self.LEVEL}/{self.NAME}/calibration_figures_{self.MODEL_NAME}", exist_ok=True)
                plt.savefig(fr"/data/MyDataBase/SWATGenXAppData/SWATplus_by_VPUID/{self.VPUID}/{self.LEVEL}/{self.NAME}/calibration_figures_{self.MODEL_NAME}/GlobalBestImprovement.png", dpi=300)
    ...
    def cleanup_scenario_directory(self, message):
        ...
        delete_previous_runs(
            f"/data/MyDataBase/SWATGenXAppData/SWATplus_by_VPUID/{self.VPUID}/{self.LEVEL}/{self.NAME}/{self.MODEL_NAME}/Scenarios"
        )
