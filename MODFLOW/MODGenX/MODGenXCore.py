...
class MODGenXCore:
	def __init__(self, NAME, BASE_PATH, LEVEL, RESOLUTION, MODEL_NAME, ML, SWAT_MODEL_NAME):
		...
		self.shape_geometry = f"/data/MyDataBase/SWATGenXAppData/SWAT_input/{LEVEL}/{NAME}/{SWAT_MODEL_NAME}/Watershed/Shapes/SWAT_plus_subbasins.shp"
		...
		self.raster_path               = os.path.join(self.raster_folder, f'{NAME}_DEM_{RESOLUTION}m.tif.tif')
		...
		self.temp_image                = f'/data/MyDataBase/SWATGenXAppData/codes/MODFLOW/MODGenX/_temp/{self.NAME}_{self.MODEL_NAME}.jpeg'
	...
	def create_modflow_model(self):
		...
		model_input_figure_path = f"/data/MyDataBase/SWATGenXAppData/SWAT_input/{self.LEVEL}/{self.NAME}/{self.MODEL_NAME}/input_figures.jpeg"
