...
class PathHandler:
    ...
    def get_database_file_paths(self) -> Dict[str, str]:
        ...
        return {
            ...
            "huc12": self.get_genxapp_data_path("NHDPlusHR/WBDHU12/WBDHU12_26990.geojson"),
            "huc8": self.get_genxapp_data_path("NHDPlusHR/WBDHU8/WBDHU8_26990.geojson"),
            "huc4": self.get_genxapp_data_path("NHDPlusHR/WBDHU4/WBDHU4_26990.geojson"),
            "streams": self.get_genxapp_data_path("NHDPlusHR/streams.pkl"),
