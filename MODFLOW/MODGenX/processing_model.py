...
#if os.path.exists(f'/data/MyDataBase/SWATGenXAppData/SWAT_input/{LEVEL}/{NAME}/best_solution.txt'):
...
#        )
    ...
    model_input_figure_path = f"/data/MyDataBase/SWATGenXAppData/SWAT_input/{LEVEL}/{NAME}/{MODEL_NAME}/input_figures.jpeg"
