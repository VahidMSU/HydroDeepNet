...
RESOLUTION = 250
path = f"/data/MyDataBase/SWATGenXAppData/Recharge/Recharge_rasterized_{RESOLUTION}m.tif"
reference_raster = f"/data/MyDataBase/SWATGenXAppData/all_rasters/DEM_{RESOLUTION}m.tif"
output_path = os.path.join("/data/MyDataBase/SWATGenXAppData/all_rasters", f"Recharge_{RESOLUTION}m.tif")
