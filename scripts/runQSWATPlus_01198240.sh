...
echo "Fixing ownership and permissions for /data/SWATGenXApp/Users/vahidr32/SWATplus_by_VPUID/0110/huc12/01198240/SWAT_MODEL_Web_Application"
chown -R $(id -u):$(id -g) "/data/SWATGenXApp/Users/vahidr32/SWATplus_by_VPUID/0110/huc12/01198240/SWAT_MODEL_Web_Application"
chmod -R 777 "/data/SWATGenXApp/Users/vahidr32/SWATplus_by_VPUID/0110/huc12/01198240/SWAT_MODEL_Web_Application"
xvfb-run -a python3 -c "from QSWATPlus3_64 import runHUCProject; runHUCProject(VPUID='0110', LEVEL='huc12', NAME='01198240', MODEL_NAME='SWAT_MODEL_Web_Application', SWATGenXPaths_swatgenx_outlet_path='/data/SWATGenXApp/Users/vahidr32/SWATplus_by_VPUID/')"
