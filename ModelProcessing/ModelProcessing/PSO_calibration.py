		...
		def ask(self):
				...
				with Manager() as manager:
						...
						for It in range(self.max_it):
								...
								if It > 50 and np.std(self.GlobalBestScore_collection[-self.termination_tolerance:]) < self.epsilon:
								...
								os.makedirs(fr"/data/MyDataBase/SWATplus_by_VPUID/{self.VPUID}/{self.LEVEL}/{self.NAME}/calibration_figures_{self.MODEL_NAME}", exist_ok=True)
								plt.savefig(fr"/data/MyDataBase/SWATplus_by_VPUID/{self.VPUID}/{self.LEVEL}/{self.NAME}/calibration_figures_{self.MODEL_NAME}/GlobalBestImprovement.png", dpi=300)
