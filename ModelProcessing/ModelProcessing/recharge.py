...
def create_recharge_shapefile(LEVEL,VPUID, NAME,RESOLUTION, recharge, year,rech_out_folder):
		input_grids_path = f'/data/MyDataBase/SWATGenXAppData/SWAT_input/huc12/{NAME}/MODFLOW_{RESOLUTION}m/Grids_MODFLOW/Grids_MODFLOW.shp'
...
if __name__ == "__main__":
		...
		end_year = 2020
		nyskip = 3
		gis_folder = "/data/MyDataBase/SWATplus_by_VPUID"
		...
		for NAME in NAMES:
				...
				for i in range(5):
						...
						gwflow_target_path = f"/data/MyDataBase/SWATplus_by_VPUID/{VPUID}/huc12/{NAME}/{MODEL_NAME}/Scenarios/Scenario_{SCENARIO}"
						rech_out_folder = f"/data/MyDataBase/SWATplus_by_VPUID/{VPUID}/huc12/{NAME}/recharg_output_{MODEL_NAME}/{SCENARIO}"
