...
###################### Note ##############################
def wrapped_model_processor(BASE_PATH, VPUID, LEVEL, NAME, MODEL_NAME, sensitivity_flag=False, calibration_flag=True, verification_flag=False):
...
if __name__ == "__main__":
	...
	LEVEL = 'huc12'
	username = "admin"
	SWATGenXPaths = SWATGenXPaths(username=username)
	...
	for NAME in NAMES:
		...
		wrapped_model_processor = wrapped_model_processor(BASE_PATH, VPUID, LEVEL, NAME, MODEL_NAME)
