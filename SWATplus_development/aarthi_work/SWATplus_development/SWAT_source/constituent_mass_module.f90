      ...
      type (exco_pathogens), dimension (:), allocatable :: exco_path        !pathogen export coefficients
      
      type dr_pathogens
        real, dimension (:), allocatable :: path         !pathogen delivery
      end type dr_pathogens
      type (dr_pathogens), dimension (:), allocatable :: dr_path            !pathogen delivery ratios
