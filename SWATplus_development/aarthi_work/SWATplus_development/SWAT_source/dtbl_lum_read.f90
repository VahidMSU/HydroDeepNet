      ...
      if (.not. i_exist .or. in_cond%dtbl_lum == "null") then
        ...
        write(9001,*) 'debug, dtbl_lum, No land use decision table file found'
      else
        ...
        do
          ...
          do i = 1, mdtbl
            ...
            write(9001,*) 'debug ', dtbl_lum(i)%name, dtbl_lum(i)%conds, dtbl_lum(i)%alts, dtbl_lum(i)%acts
            ...
            call initialize_decision_table(dtbl_lum(i))
            ...
            do iac = 1, dtbl_lum(i)%acts
                ...
                case ("plant")
                  ...
                  do idb = 1, db_mx%transplant
                    if (dtbl_lum(i)%act(iac)%file_pointer == transpl(idb)%name) then
                      ...
                      write(9001,*) "plant"," dtbl_lum(i)%act_app(iac) = ", dtbl_lum(i)%act_app(iac), "idb = ", idb
                      exit
                    else
                      dtbl_lum(i)%act_app(iac) = 0
                    endif
                  end do
                ...
                case ("fertilize")
                  ...
                  do idb = 1, db_mx%chemapp_db
                    if (dtbl_lum(i)%act(iac)%file_pointer == chemapp_db(idb)%name) then
                      dtbl_lum(i)%act_app(iac) = idb
                      write(9001,*) "fertilize",' ',"dtbl_lum(i)%act_app(iac) = ", dtbl_lum(i)%act_app(iac), "idb = ", idb
                      exit
                    endif
                  end do
                ...
                case ("fert_future")
                  ...
                  do idb = 1, db_mx%chemapp_db
                    if (dtbl_lum(i)%act(iac)%file_pointer == chemapp_db(idb)%name) then
                      dtbl_lum(i)%act_app(iac) = idb
                      write(9001,*) "fert_future","dtbl_lum(i)%act_app(iac) = ", dtbl_lum(i)%act_app(iac), "idb = ", idb
                      exit
                    endif
                  end do
                ...
                case ("manure_demand")
                  ...
                  do idb = 1, db_mx%chemapp_db
                    if (dtbl_lum(i)%act(iac)%option == chemapp_db(idb)%name) then
                      dtbl_lum(i)%act_app(iac) = idb
                      write(9001,*) "manure_demand","dtbl_lum(i)%act_app(iac) = ", dtbl_lum(i)%act_app(iac), "idb = ", idb
                      exit
                    endif
                  end do
                ...
                case ("pest_apply")
                  ...
                  do idb = 1, db_mx%chemapp_db
                    if (dtbl_lum(i)%act(iac)%file_pointer == chemapp_db(idb)%name) then
                      dtbl_lum(i)%act_app(iac) = idb
                      write(9001,*) "pest_apply","dtbl_lum(i)%act_app(iac) = ", dtbl_lum(i)%act_app(iac), "idb = ", idb
                      exit
                    endif
                  end do
