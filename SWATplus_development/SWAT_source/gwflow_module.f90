...
real, dimension (:,:), allocatable :: ss_rechn_cell_total,ss_gwswn_cell_total,ss_satexn_cell_total,ss_tilen_cell_total, &
										ss_trann_cell_total,ss_pumpagn_cell_total, ss_pumpexn_cell_total, ss_laken_cell_total
integer :: out_gwbalp, out_gwbalp_yr, out_gwbalp_aa
real :: gw_reta_p
real :: pmass_change_yr, ss_rechp_yr, ss_gwp_yr, ss_swp_yr,ss_satexp_yr,ss_advp_yr,ss_dspp_yr,ss_rctp_yr,ss_pumpagp_yr, &
		ss_pumpexp_yr, ss_tilep_yr,ss_tranp_yr,ss_lakep_yr
