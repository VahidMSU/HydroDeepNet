                  ...
                  if(gwflow_flag ==1) then
                    ...
                    if(hru_num_cells(j).gt.0) then
                      ...
                      do i=1,hru_num_cells(j)
                        ...
                        gwvol_avail = ((gw_cell_head(cell_row,cell_col)-gw_cell_bot(cell_row,cell_col)) * (cell_size * cell_size)) &
										* gw_cell_Sy(cell_row,cell_col) !m3 of groundwater available for removal
