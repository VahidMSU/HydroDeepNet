      ...
      write(out_gwobs_ss,*) 'head,volume_before,volume_after,rech,et,gw2sw,sw2gw,satex,lateral,pumpag,pumpex,tile,gw2soil,lake'  
...
30      cell_num_hrus(cell_row,cell_col) = hru_count
      ...
      write(out_gwbal,*)
	  gwflow_hdr_day = (/"  year ","  day  ","ts     ","vol_bef","vol_aft","rech   ","gwet   ","gwsw   ",&
	  		"swgw   ","satex  ","gwsoil ", "bound  ","pump_ag","pump_ex","tile   ","lake   ","error  ","satfr  ","wtdepth"/)
      ...
      write(out_gwbal_yr,*)
      gwflow_hdr_yr = (/"  year ","delvol ","rech   ","gwet   ","gwsw   ","swgw   ",&
	  		"satex  ","gwsoil ","bound  ","pump_ag","pump_ex","tile   ","lake   "/)
      ...
      write(out_gwbal_aa,*)
      gwflow_hdr_aa = (/"  year "," delvol"," rech  ","  gwet ","  gwsw ","  swgw ", &
	  		" satex "," gwsoil"," bound ","pump_ag","pump_ex","  tile ","  lake "/)
      ...
      if(gw_transport_flag.eq.1) then
        ...
        write(out_gwbaln,*)
        gwflown_hdr_day = (/"   year","    day","     ts","massbef","massaft","rech   ","gwsw   ","swgw   ",&
			"satex  ","gwsoil ","adv    ","dsp    ","rct    ", "pump_ag","pump_ex","   tile","   lake","  error"/)
        ...
        write(out_gwbalp,*)
        gwflowp_hdr_day = (/"  year ","  day  ","  ts   ","massbef","massaft","  rech ","  gwsw ","  swgw ", &
				" satex "," gwsoil", "  adv  ","  dsp  ","  rct  ", "pump_ag","pump_ex","  tile ","  lake "," error "/)
        ...
        write(out_gwbaln_yr,*)
        gwflown_hdr_yr = (/"  year ","delmass"," rech  "," gwsw  ","  swgw "," satex ", & 
				" gwsoil","  adv  ","  dsp  ","  rct  ","pump_ag","pump_ex"," tile  "," lake  "/) 
        ...
        write(out_gwbalp_yr,*)
        gwflowp_hdr_yr = (/"  year ","delmass"," rech  ","  gwsw "," swgw  "," satex ", &
				" gwsoil","  adv  ","  dsp  ","  rct  ","pump_ag","pump_ex","  tile ","  lake "/)
        ...
        write(out_gwbaln_aa,*)
        gwflown_hdr_aa = (/"  year ","delmass"," rech  "," gwsw  "," swgw  "," satex "," gwsoil", &
			"  adv  ","   dsp ","   rct ","pump_ag","pump_ex","   tile","  lake "/)
        ...
        write(out_gwbalp_aa,*)
        gwflowp_hdr_aa = (/"  year ","delmass","  rech ","  gwsw ","  swgw "," satex "," gwsoil", &
				"  adv  ","  dsp  ","  rct  ","pump_ag","pump_ex","  tile "," lake  "/)
      ...
      write(out_hyd_sep,*)
	  hydsep_hdr = (/"     year     ","     day      ","   channel    ","  chan_surf   ","   chan_lat   ","   chan_gwsw  ", &
			"  chan_swgw   "," chan_satexgw "," chan_satexsw ","   chan_tile  "/)
