    ...
    def save_h5_data(self, region, model, scenario, ensemble, variable_a, var_to_extract, units, time_range, time_step, file_path, lats, lons):
        ...
        with h5py.File(self.out_h5_path, open_type) as f:
            ...
            if dataset_name in group:
                print(f"Dataset {dataset_name} already exists in group {group_path}.")
            else:
                ...
                print(f"Data saved in group {group_path} with dataset {dataset_name}")
                    ...
                    for file in files:
                        ...
                        with open(os.path.join(self.current_dir, "log.txt"), 'a') as f:
                            ...
                            try:
                                ...
                                with open(os.path.join(self.current_dir, "log_error.txt"), 'a') as f:
                                    f.write(f"model={model}, scenario={scenario}, ensemble={ensemble}, variable={variable} Error: {e}\n")
...
if __name__ == "__main__":
    ...
    if linux:
        cc_base_path = "/data/climate_change/cirrus.ucsd.edu/~pierce/LOCA2/CONUS_regions_split/"
        reference_raster = "/data/reference_rasters/DEM_250m.tif"
        cc_model_list = "/data/climate_change/list_of_all_models.txt"
        out_h5_path = "/data/climate_change/LOCA2_extracted.h5"
    else:
        cc_base_path     = "E:/MyDataBase/climate_change/cirrus.ucsd.edu/~pierce/LOCA2/CONUS_regions_split/"
        ...
        out_h5_path = "E:/MyDataBase/climate_change/LOCA2_MLP_2.h5"
...
if __name__ == "__main__":
    ...
    cc_base_path = "/data/MyDataBase/climate_change/cirrus.ucsd.edu/~pierce/LOCA2/CONUS_regions_split/"
    reference_raster = "/data/reference_rasters/DEM_250m.tif"
